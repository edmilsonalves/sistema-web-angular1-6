...
<!-- top navigation -->
 <header class="main-header">
    ...
    <a href="dashboard.html" class="logo">
      ...
      <span class="logo-mini"><b>DISK</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>${empresaLogada}</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="assets/dist/img/usuario.png" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ${usuarioLogado} - Cargo
                  <small>07 de abril de 2017</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="/sistema-web/logout" class="btn btn-default btn-flat">Sair</a>
                </div>
              </li>
            </ul>
          </li>
